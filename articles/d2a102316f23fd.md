...
2. **利用可能なディストリビューションを確認します**
   ...
   wsl --list --online
   ```
   ![wsl_available_distributions.png](https://raw.githubusercontent.com/takuya-motoshima/zenn-content/main/images/d2a102316f23fd/wsl_available_distributions.png)
...
4. **Ubuntuのユーザーアカウントを作成します**
   ...
   ![wsl_ubuntu_user_setup.png](https://raw.githubusercontent.com/takuya-motoshima/zenn-content/main/images/d2a102316f23fd/wsl_ubuntu_user_setup.png)
5. **インストール完了の確認**
   入力が完了するとWSL上のUbuntu-24.04の仮想マシンが立ち上がります。
   ![wsl_ubuntu_ready.png](https://raw.githubusercontent.com/takuya-motoshima/zenn-content/main/images/d2a102316f23fd/wsl_ubuntu_ready.png)
...
6. **curlのインストール**
   ...
   ```
   ![wsl_curl_installed.png](https://raw.githubusercontent.com/takuya-motoshima/zenn-content/main/images/d2a102316f23fd/wsl_curl_installed.png)
...
1. **NVM（Node Version Manager）をインストールします**
  ...
  exec $SHELL
  ```
  ![nvm_installation.png](https://raw.githubusercontent.com/takuya-motoshima/zenn-content/main/images/d2a102316f23fd/nvm_installation.png)
2. **Node.jsをインストールします**
  ```bash
  nvm install --lts
  ```
...
1. **Claude Codeをインストールします**
  ...
  ```
  ![claude_code_installation.png](https://raw.githubusercontent.com/takuya-motoshima/zenn-content/main/images/d2a102316f23fd/claude_code_installation.png)
2. **インストール確認**
  ```bash
  claude --version
  ```
  ![claude_code_version_check.png](https://raw.githubusercontent.com/takuya-motoshima/zenn-content/main/images/d2a102316f23fd/claude_code_version_check.png)
