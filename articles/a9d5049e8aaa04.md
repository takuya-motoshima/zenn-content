...
- **Shopify**（世界最大級のECプラットフォーム）: リアルタイム売上マップで、データ遅延をミリ秒単位まで改善 ([参考](https://shopify.engineering/server-sent-events-data-streaming))

  ![Shopify SSE事例](/images/a9d5049e8aaa04/shopify-sse.png)

- **PKSHA Technology**（国内大手AIソリューション企業）: コールセンター向けAIで、通話のリアルタイム文字起こしに活用 ([参考](https://voice.pkshatech.com/n/n5e88534c70db))

  ![PKSHA Technology SSE事例](/images/a9d5049e8aaa04/pksha-sse.png)
