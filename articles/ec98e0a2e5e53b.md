...
![Windowsターミナルのインストール](/images/ec98e0a2e5e53b/install-windows-terminal.png)
...
2. ライセンスに同意して「次へ」。
   ...
   ![Gitのインストール1](/images/ec98e0a2e5e53b/install-git-1.png)

3. コンポーネントの選択ではそのまま「次へ」。

   ![Gitのインストール2](/images/ec98e0a2e5e53b/install-git-2.png)

4. ブランチ名は「main」にしておくとGitHubと相性◎。

   ![Gitのインストール3](/images/ec98e0a2e5e53b/install-git-3.png)

5. 認証補助には「Git Credential Manager Core」を選んでおくと便利です。
   （2回目以降のログインが楽になります）

   ![Gitのインストール4](/images/ec98e0a2e5e53b/install-git-4.png)

6. 最後にそのまま進めてインストール完了！

   ![Gitのインストール5](/images/ec98e0a2e5e53b/install-git-5.png)
...
![WSLカーネル更新](/images/ec98e0a2e5e53b/enable-wsl2-1.png)
...
![Ubuntuのインストール](/images/ec98e0a2e5e53b/enable-wsl2-2.png)
...
2. 「Download for Windows」でインストーラをダウンロードします。
   ...
   ![Dockerのダウンロード](/images/ec98e0a2e5e53b/install-docker-2.png)

3. ダウンロードしたインストーラを実行し、「Install required Windows components for WSL 2」にチェックがあることを確認して次へ。

   ![Dockerのインストール](/images/ec98e0a2e5e53b/install-docker-3.png)

4. インストール完了後、Docker Desktopを起動。

   ![Docker起動](/images/ec98e0a2e5e53b/install-docker-4.png)

5. チュートリアルは「Skip」でスキップ。

   ![Dockerスキップ](/images/ec98e0a2e5e53b/install-docker-5.png)

6. 「Settings → Resources → WSL Integration」で「Ubuntu-20.04」にチェックを入れ、DockerをWSL上で使えるようにします。

   ![Docker WSL統合](/images/ec98e0a2e5e53b/install-docker-6.png)
